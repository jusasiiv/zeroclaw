...
impl Tool for CronAddTool {
    ...
    fn description(&self) -> &str {
        "Create a scheduled cron job (shell or agent) with cron/at/every schedules. \
         ...
         To deliver output to a channel (Discord, Telegram, Slack, Mattermost, Matrix, WhatsApp, Webhook), set \
            ...
            "properties": {
                ...
                "delivery": {
                    ...
                    "properties": {
                        ...
                        "channel": {
                            "type": "string",
                            "enum": ["telegram", "discord", "slack", "mattermost", "matrix", "whatsapp", "webhook"],
                            "description": "Channel type to deliver output to"
                        },
                        "to": {
                            "type": "string",
                            "description": "Destination ID recipient: Discord channel ID, Telegram chat ID, Slack channel name, WhatsApp/Webhook phone number (E.164). Never a URL."
                        },
                        "best_effort": {
                            "type": "boolean",
